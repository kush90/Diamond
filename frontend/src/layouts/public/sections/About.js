    ...
    <StyledSection>
      <Grid container spacing={4} alignItems="center">
        <Grid item xs={12} md={6}>
          ...
          <Typography variant="body1" paragraph>
            Welcome to our new online jewelry shop, the premier platform revolutionizing the jewelry market. Our platform not only connects buyers with exquisite jewelry but also empowers brokers to facilitate transactions seamlessly, earning substantial rewards in the process.
          </Typography>
          <Typography variant="h6" fontWeight="bold" gutterBottom>
            Broker-Friendly Platform
          </Typography>
          <Typography variant="body1" paragraph>
            We provide a unique opportunity for brokers to become an integral part of the jewelry industry by registering on our platform. Brokers play a pivotal role in connecting potential buyers with the jewelry they desire, and for their efforts, they earn a competitive 10% fee on every successful deal.
          </Typography>
          <Typography variant="h6" fontWeight="bold" gutterBottom>
            Unmatched Product Assurance
          </Typography>
          <Typography variant="body1" paragraph>
            Every product listed on our platform comes with a 100% warranty, providing peace of mind to buyers. This warranty guarantees the authenticity, quality, and craftsmanship of our jewelry, allowing customers to shop with confidence.
          </Typography>
          <Typography variant="h6" fontWeight="bold" gutterBottom>
          ...
          <Box mt={2}>
            ...
            <ul>
              <li><Typography variant="body1"><strong>Diverse Product Range:</strong> Our catalog features a wide selection of high-quality jewelry, catering to every taste and occasion.</Typography></li>
        ...
        <Grid item xs={12} md={6}>
          <StyledImage src={img11} alt="Vision and Mission" />
        </Grid>
      </Grid>
    </StyledSection>
  </Container>
